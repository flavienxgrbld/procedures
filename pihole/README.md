...
`ash
bash install_pihole.sh
`

### Étapes détaillées
### Installation de Pihole

Le script `install_pihole.sh` installe les dépendances nécessaires et déploie Pihole.
...
- Vérification des ports exposés : 53, 80, 443.
...
## Documentation
- [Site officiel](https://pi-hole.net)
