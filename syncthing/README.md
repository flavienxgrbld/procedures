...
Syncthing - Synchronisation distribuée P2P
...
- **syncthing@$USER** - Service système avec démarrage automatique
...
- /var/lib/syncthing/ - Données de l'application
...
**Testé sur** : apt (Debian/Ubuntu), dnf/yum (RedHat/Fedora), zypper (openSUSE), pacman (Arch)
