...
Request Bin - Débogage de webhooks HTTP
...
- **redis-server** - Service système avec démarrage automatique
- **requestbin** - Service système avec démarrage automatique
...
- /var/lib/requestbin/ - Données de l'application
