# Installation matrix_synapse

## Description
Matrix Synapse - Serveur protocol collaboratif
...
`ash
bash install_matrix_synapse.sh
`

### Étapes détaillées
### Installation de Matrix Synapse

Le script `install_matrix_synapse.sh` installe les dépendances nécessaires et déploie Matrix Synapse.
...
## Documentation
- [Site officiel](https://matrix.org)
- [Documentation](https://matrix.org/docs/guides/install-synapse)
