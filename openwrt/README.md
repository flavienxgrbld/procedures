...
## Description
OpenWrt - Système d'exploitation WiFi/routeur
...
Le script `install_openwrt.sh` installe les dépendances nécessaires et déploie Openwrt.
...
## Documentation
- [Site officiel](https://openwrt.org)
