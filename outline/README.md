...
## Description
Outline - Wiki collaboratif moderne
...
### Étapes détaillées
### Installation de Outline

Le script `install_outline.sh` installe les dépendances nécessaires et déploie Outline.
...
- Vérification des ports exposés : 3000.
...
- [Documentation](https://www.getoutline.com/docs)
