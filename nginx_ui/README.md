# Installation nginx_ui

## Description
Nginx UI - Interface de gestion Nginx
...
`ash
bash install_nginx_ui.sh
`

### Étapes détaillées
### Installation de Nginx Ui

Le script `install_nginx_ui.sh` installe les dépendances nécessaires et déploie Nginx Ui.
...
- Vérification des ports exposés : 8080, 8443.
...
## Documentation
- [Site officiel](https://www.nginx.com)
