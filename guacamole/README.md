...
## Description
Apache Guacamole - Accès aux bureaux RDP/SSH/VNC
...
`ash
bash install_guacamole.sh
`

### Étapes détaillées
### Installation de Guacamole

Le script `install_guacamole.sh` installe les dépendances nécessaires et déploie Guacamole.
...
- Vérification des ports exposés : 8080.
