...
`ash
bash install_hurl.sh
`

### Étapes détaillées
### Installation de Hurl

Le script `install_hurl.sh` installe les dépendances nécessaires et déploie Hurl.
