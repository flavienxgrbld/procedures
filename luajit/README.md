...
## Description
LuaJIT - Compilateur Just-In-Time Lua
...
Le script `install_luajit.sh` installe les dépendances nécessaires et déploie Luajit.
...
## Documentation
- [Site officiel](https://luajit.org)
- [Documentation](https://luajit.org/)
